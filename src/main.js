...
const routes = [
  ...
  { path: '/hosts/:id', name: 'host-detail', component: () => import('./views/HostDetail.vue'), meta: { requiresAuth: true } },
  ...
  { path: '/screens/:id', name: 'screen-detail', component: () => import('./views/ScreenDetail.vue'), meta: { requiresAuth: true } },
